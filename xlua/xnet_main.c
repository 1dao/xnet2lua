...
static xArgsCFG g_arg_configs[] = {
    ...
    { 0,   "XADMIN_SUPER_TOKEN", NULL, 0 },
    { 0,   "XADMIN_HEARTBEAT_MS", NULL, 0 },
    { 0,   "XADMIN_PEER_TTL_MS", NULL, 0 },
    { 0,   "XADMIN_DATA_FILE", NULL, 0 },
    { 0,   "XADMIN_DB_HOST", NULL, 0 },
    { 0,   "XADMIN_DB_PORT", NULL, 0 },
    { 0,   "XADMIN_DB_USER", NULL, 0 },
    { 0,   "XADMIN_DB_PASSWORD", NULL, 0 },
    { 0,   "XADMIN_DB_DATABASE", NULL, 0 },
